...
import { idlFactory } from './h2o-monitor-frontend.did.js';
export { idlFactory } from './h2o-monitor-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_H2O_MONITOR_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./h2o-monitor-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the h2o-monitor-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./h2o-monitor-frontend.did.js")._SERVICE>}
 */
export const h2o_monitor_frontend = createActor(canisterId);
